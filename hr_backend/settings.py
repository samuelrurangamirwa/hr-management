...
SECRET_KEY = 'django-insecure-c_8o+(jg$nug+4!*3ad@73-c^r&wr^1cst_n%ofr$jdy52id94'
...
MIDDLEWARE = [
    ...
    # 'django.middleware.common.CommonMiddleware',  # Disabled for API
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "https://hr-management-pearl-gamma.vercel.app",
]
